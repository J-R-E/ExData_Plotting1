...
png(filename = "plot1.png", width = 480, height = 480, units = "px") ## Opens PNG device; creates 
                                                                     ## "plot1.png" in working directory. 
                                                                    
{hist(data_change_class_subset$Global_active_power, main = "Global Active Power", 
      xlab = "Global Active Power (kilowatts)", col = "red")} ## Creates a plot and sends it to a file.
